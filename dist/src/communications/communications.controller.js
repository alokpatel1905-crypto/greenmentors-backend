...
let CommunicationsController = class CommunicationsController {
    ...
    findAllAnnouncements(page = '1', limit = '10') {
    ...
    findAllSubscribers(page = '1', limit = '10') {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CommunicationsController.prototype, "findAllAnnouncements", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CommunicationsController.prototype, "removeAnnouncement", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], CommunicationsController.prototype, "subscribe", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], CommunicationsController.prototype, "findAllSubscribers", null);
__decorate([
    (0, common_1.Post)('newsletter/broadcast'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'CONTENT_EDITOR'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], CommunicationsController.prototype, "broadcast", null);
