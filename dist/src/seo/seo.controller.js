...
let SeoController = class SeoController {
    ...
    updatePageSeo(id, body) {
        return this.seoService.updatePageSeo(id, body);
    }
    updateProgramSeo(id, body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], SeoController.prototype, "getStats", null);
__decorate([
    (0, common_1.Patch)('page/:id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'CONTENT_EDITOR'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], SeoController.prototype, "updateProgramSeo", null);
