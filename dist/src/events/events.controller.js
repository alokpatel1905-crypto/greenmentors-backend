...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], EventsController.prototype, "addSpeaker", null);
__decorate([
    (0, common_1.Delete)('speakers/:speakerId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'PROGRAM_MANAGER'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], EventsController.prototype, "removeSpeaker", null);
__decorate([
...
__decorate([
    (0, common_1.Patch)('registrations/:regId/status'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'PROGRAM_MANAGER'),
    ...
    __metadata("design:returntype", void 0)
], EventsController.prototype, "updateRegStatus", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'PROGRAM_MANAGER'),
    __param(0, (0, common_1.Param)('id')),
